...
namespace Senz_Program
{
    public class Score_Mass : MonoBehaviour
    {
        ...
        public int Score()
        {
            _PlayerStatus.Plus_HealthScore = (int)_HealthSystem.CurrentHealth * 1500;
            _PlayerStatus.Plus_ItemScore = _PlayerStatus.Player_GetItems * 500;
            _PlayerStatus.Plus_ClearTimeScore = 1000000 / (int)_MainSystem.Stage_ProgressTime;
